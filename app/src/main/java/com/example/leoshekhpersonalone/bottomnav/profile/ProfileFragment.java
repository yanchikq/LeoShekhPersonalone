package com.example.leoshekhpersonalone.bottomnav.profile;
...
import com.example.leoshekhpersonalone.LoginActivity;
import com.example.leoshekhpersonalone.databinding.FragmentFindBinding;
import com.example.leoshekhpersonalone.databinding.FragmentProfileBinding;
        ...
        FirebaseDatabase.getInstance().getReference().child("Users").child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        String profileImage = snapshot.child("profilelmage").getValue().toString();
